...
def split_data(str):
    ...
    runtime = str_split[5]
    screens = str_split[6]
    opening_week = str_split[7]
    country = str_split[11]
    user_vote = str_split[10]
    ratings = str_split[9]
    critic_vote = str_split[13]
    meta_score = str_split[14]
    genres = str_split[12]
...
new_movie1 = split_data("tt1098327,rl1447986689,Dragonball Evolution,PG,30000000.0,85.0,2181.0,4756488.0,9362785.0,2.5,79000.0,United States,Action Adventure Fantasy Sci-Fi Thriller,10.0,45.0,0,4.0,2009.0")

predicted_revenue = predict_revenue(new_movie1)
